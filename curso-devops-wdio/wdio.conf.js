...
if (!AMBIENTE || !['qa', 'staging', 'prod'].includes(AMBIENTE)) {
  //si no se selecciona un ambiente válido se corta el proceso
  console.log('No se seleccionó un ambiente válido');
  process.exit();
}
...
exports.config = {
  ...
  suites: {
    smoke: ['./tests/opencart.search.js'],
    login: ['./tests/opencart.login.js'],
  },
  //
  // ============
  // Capabilities
